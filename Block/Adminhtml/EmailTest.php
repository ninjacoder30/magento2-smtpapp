...
namespace Allure\SmtpApp\Block\Adminhtml;
...
use Allure\SmtpApp\Model\Email;
use Zend_Mail;
...
/**
 * Class EmailTest
 * @package Allure\SmtpApp\Block\Adminhtml
 */
    ...
    protected function validateMagentoEmailSetting()
    {
        ...
        try {
            $this->_email
                ...
                ->send(
                    ['email' => $this->fromAddress, 'name' => 'Test from Allure SMTP'],
